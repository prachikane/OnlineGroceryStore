<?php
    ...
    $sql = "SELECT * FROM inventory where category = 'snacks'";
    ...
    if (isset($_POST['category']) && isset($_POST['search'])) {
        ...
        if ($category == 'Shop All') {
            ...
            $sql = "SELECT * FROM inventory where category = 'snacks' and itemname LIKE '%$search%'";
        }   
    }
                    ...
                    <?php
                        if ($products->num_rows > 0) {
                            while ($row = $products->fetch_assoc()) {
                                ?>
                                <div class="card">
                                    <img src="./snacks/<?php echo $row["img"] ?>"/>
